 ...
 * @param {number|string} params.videoId 视频ID
 ...
 */
export function deleteComment(commentId: number | string): Promise<ApiResponse<void>> {
  return request({
 ...
 */
export function getCommentLikeCount(id: number | string): Promise<ApiResponse<{ count: number }>> {
  return request({
 ...
 */
export function checkCommentLiked(id: number | string): Promise<ApiResponse<{ liked: boolean }>> {
  return request({
